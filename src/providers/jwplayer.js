...
export default {
  patterns: [/https?:\/\/(?:cdn\.)?jwplayer\.com\/players\/(\w+)(?:-(\w+))?/],
  ...
  async serialize(data) {
    ...
    return {
      ...
      html: `<div style="padding-bottom:${
        (data.height / data.width) * 100
      }%; position:relative;"><iframe src="${
        data.embed_url
      }" width="100%" style="top:0; left:0; width:100%; height:100%; position:absolute; border:0;" allowfullscreen scrolling="no" allow="autoplay; fullscreen; picture-in-picture; encrypted-media; gyroscope; accelerometer"></iframe></div>`,
    }
  },
}
